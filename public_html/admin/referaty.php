...
$stmt = $pdo->query("
    SELECT r.id, r.tytul, r.data_zgloszenia, r.status, r.plik, u.imie, u.nazwisko
    FROM {$prefix}referaty r
    JOIN {$prefix}uzytkownik u ON r.uczestnik_id = u.id
                ...
                <tbody>
                    <?php foreach ($referaty as $r): ?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($r['imie']) . ' ' . htmlspecialchars($r['nazwisko']) ?></td>
                            ...
                            <td>
                                ...
                                ?>
                                <span class="badge badge-<?= $kolor ?>"><?= $r['status'] ?></span>
                            </td>
                            <td>
                                <?php if ($r['plik']): ?>
                            ...
                            <td>
                                <?php if ($r['status'] === 'oczekujący'): ?>
                                    <a href="referat_status.php?id=<?= $r['id'] ?>&akcja=zaakceptuj" class="btn btn-success btn-sm">Akceptuj</a>
                                    <a href="referat_status.php?id=<?= $r['id'] ?>&akcja=odrzuc" class="btn btn-danger btn-sm">Odrzuć</a>
                                <?php else: ?>
